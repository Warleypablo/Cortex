...
export function montarSecoesEntregas(
  ...
  // Só produtos COM lead time no mês — descarta as linhas "zeradas" (atual null/0, que
  // apareciam com todas as colunas "—"). Produtos sem entrega no mês somem da tabela.
  const leadTimeRows = leadTimeRowsRaw.filter((r) => r.atual != null && r.atual !== 0);
