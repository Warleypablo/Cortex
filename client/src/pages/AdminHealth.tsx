...
import { Loader2, RefreshCw, Database, Server, Activity, BarChart3, CheckCircle2, XCircle, AlertCircle } from "lucide-react";
    ...
    <div className="p-6 space-y-6" data-testid="page-admin-health">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard
          ...
          subtitle={`Total: ${data?.memory.heapTotal || 0} MB`}
          icon={Activity}
          status={(data?.memory.heapUsed || 0) < (data?.memory.heapTotal || 1) * 0.8 ? "ok" : "warning"}
        />
        <StatCard
          title="RSS"
