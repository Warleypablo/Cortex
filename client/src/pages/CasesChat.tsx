      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute bottom-full right-0 mb-2 w-[260px] bg-slate-800 border border-slate-700 rounded-2xl shadow-2xl overflow-hidden z-50 p-1.5"
          >
            {models.map(model => (
              <button
                key={model.id}
                ...
                className="w-full text-left px-3 py-2.5 rounded-xl flex items-start justify-between transition-colors hover:bg-slate-700/50"
                data-testid={`button-model-${model.id}`}
              >
                <div className="flex flex-col gap-0.5">
                  <span className="text-[13px] font-semibold text-slate-100">{model.name}</span>
                  <span className="text-[11px] text-slate-400">{model.description}</span>
                </div>
...
export default function CasesChat() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-80px)] bg-slate-900" data-testid="cases-chat-page">
          ...
          <AnimatePresence mode="wait">
            {messages.length === 0 ? (
              ...
              >
                ...
                <h1 className="text-3xl font-bold text-slate-100 mb-3" data-testid="text-welcome-title">
                  GPTurbo
                </h1>
                <p className="text-slate-400 max-w-md text-base leading-relaxed" data-testid="text-welcome-description">
                ...
                <div className="flex flex-wrap justify-center gap-2 mt-8 max-w-lg">
                  {[
                    ...
                    <motion.button
                      ...
                      className="px-4 py-2 text-sm text-slate-300 bg-slate-800/60 border border-slate-700/50 rounded-xl hover:bg-slate-700/60 hover:border-slate-600 transition-all duration-200"
      ...
      <div className="sticky bottom-0 bg-gradient-to-t from-slate-900 via-slate-900 to-transparent pt-8 pb-6">
        <div className="max-w-3xl mx-auto px-4">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <div className={`
              ...
              focus-within:shadow-[0_0_50px_rgba(0,0,0,0.5)]
            ...
            `}>
              <div className="px-4 pt-4 pb-2">
                <textarea
                  ...
                  className="w-full bg-transparent border-0 outline-none text-slate-100 text-[16px] placeholder:text-slate-500 resize-none overflow-hidden leading-relaxed min-h-[1.5em] max-h-[200px]"
                  rows={1}
              ...
              <div className="flex items-center justify-between px-3 pb-3 pt-1">
                <div className="flex items-center gap-1">
                  ...
                  <button
                    ...
                    className="h-8 w-8 rounded-lg flex items-center justify-center text-slate-400 hover:text-slate-200 hover:bg-slate-700/50 transition-colors active:scale-95"
                    type="button"
