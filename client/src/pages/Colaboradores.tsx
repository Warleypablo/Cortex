...
function EditColaboradorDialog({ colaborador, open, onOpenChange }: { colaborador: Colaborador; open: boolean; onOpenChange: (open: boolean) => void }) {
  ...
  useEffect(() => {
    if (squads.length > 0 && colaborador.squad) {
      const matchedSquad = findMatchingSquad(colaborador.squad, squads);
      if (matchedSquad && matchedSquad !== form.getValues("squad")) {
        form.setValue("squad", matchedSquad, { shouldValidate: false });
      }
    }
  }, [squads, colaborador.squad, form]);
              ...
              <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 pb-2">
                <div className="flex items-center gap-1">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p>Colaboradores admitidos nos últimos 30 dias</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
              ...
              <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 pb-2">
                <div className="flex items-center gap-1">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p>Colaboradores desligados nos últimos 30 dias</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
