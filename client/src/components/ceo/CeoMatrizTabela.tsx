  ...
  return (
    <div className="space-y-2">
      ...
      <p className="px-1 text-[11px] text-gray-400 dark:text-zinc-500">
        ...
        andamento (parcial). Inadimplência por mês de vencimento; LTV e E-NPS são foto atual (só na coluna mais recente).
        Clique numa célula para o detalhamento do mês.
      </p>
    </div>
  );
}
