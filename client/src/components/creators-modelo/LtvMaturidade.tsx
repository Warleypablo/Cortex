      ...
      <CardContent>
        {data.maturidade.aviso && (
          <div className="mb-3 flex items-start gap-2 rounded-lg border border-amber-200 bg-amber-50 px-3 py-2 text-xs text-amber-800 dark:border-amber-900/50 dark:bg-amber-950/30 dark:text-amber-300">
            ...
            <span>Maturidades diferentes: recorrente {data.maturidade.recorrenteIdade}m vs pontual {data.maturidade.pontualIdade}m de idade média. O LTV recorrente realizado ainda vai crescer — compare pela faixa (blended → ativos), não só o blended.</span>
          </div>
        )}
