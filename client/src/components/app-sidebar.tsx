...
import {
  ...
  Star, Gauge, Bot, Link2, Package, Clapperboard, Sprout, PartyPopper, Send
} from "lucide-react";
...
const ICONS: Record<string, any> = {
  ...
  Sliders, Bell, Lightbulb, Megaphone, Ticket, Gauge, Bot, Link2, Package, Clapperboard, Sprout, PartyPopper, Send,
};
