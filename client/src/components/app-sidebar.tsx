...
import {
  ...
  Star, Gauge, Bot, Link2, Package, Clapperboard, Sprout, PartyPopper
} from "lucide-react";
...
const ICONS: Record<string, any> = {
  ...
  Sliders, Bell, Lightbulb, Megaphone, Ticket, Gauge, Bot, Link2, Package, Clapperboard, Sprout, PartyPopper,
};
