  ...
  return (
    <div className="rounded-lg border border-border bg-card overflow-auto h-full">
      ...
      <div className="sticky top-0 z-10 bg-background border-b">
        <div className="grid grid-cols-[minmax(220px,2fr)_minmax(90px,0.7fr)_minmax(100px,0.8fr)_minmax(60px,0.5fr)_minmax(90px,0.7fr)_minmax(80px,0.6fr)_minmax(80px,0.6fr)_minmax(95px,0.75fr)_minmax(95px,0.75fr)_minmax(160px,1.3fr)_minmax(150px,1.1fr)] text-sm font-medium text-muted-foreground">
          {/* Nome do Cliente */}
