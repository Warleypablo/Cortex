                ...
                <Table>
                  ...
                  <TableBody>
                    {contratos.contratos.length === 0 && (
                      <TableRow>
                        <TableCell colSpan={6} className="py-8 text-center text-sm text-gray-500 dark:text-zinc-400">Nenhum contrato encontrado</TableCell>
                      </TableRow>
                    )}
                ...
                <Table>
                  ...
                  <TableBody>
                    {clientes.clientes.length === 0 && (
                      <TableRow>
                        <TableCell colSpan={7} className="py-8 text-center text-sm text-gray-500 dark:text-zinc-400">Nenhum cliente encontrado</TableCell>
                      </TableRow>
                    )}
