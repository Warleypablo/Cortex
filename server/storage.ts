  ...
  async getClienteById(id: string): Promise<ClienteCompleto | undefined> {
    ...
    const result = await db
      .select({
        ...
        site: sql<string | null>`NULL::text`,
        email: sql<string | null>`NULL::text`,
        instagram: sql<string | null>`NULL::text`,
        linksContrato: sql<string | null>`NULL::text`,
        linkListaClickup: sql<string | null>`NULL::text`,
