...
export class DbStorage implements IStorage {
  ...
  async getContribuicaoOperadorDfc(dataInicio: string, dataFim: string, operador?: string): Promise<{
    ...
    // Lista de operadores: usa valor_pago da PARCELA (igual Colaborador) para garantir 100% cobertura
    // Atribui pelo operador do contrato mais recente do cliente
    ...
    // Query v4: IGUAL ao Colaborador mas usando cup_contratos.responsavel (operador do contrato)
    // Usa valor_pago da PARCELA para garantir 100% de cobertura
