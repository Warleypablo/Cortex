...
export const CAPACITY_METAS_SEED: CapacityMetaSeed[] = [
  ...
  { nome: "Bruno da Silva",  match_responsavel: "Bruno Da Silva",  categoria: "vendedor", cap_recorrente: null, cap_mrr: 100077.69, cap_pontual: null, cap_contas: 30, ordem: 13 },
  { nome: "José Neto",       match_responsavel: "José Neto",       categoria: "vendedor", cap_recorrente: null, cap_mrr: 73446.43,  cap_pontual: null, cap_contas: 30, ordem: 14 },
  { nome: "Gabriel Magno",   match_responsavel: "Gabriel Magno",   categoria: "vendedor", cap_recorrente: null, cap_mrr: 54330.91,  cap_pontual: null, cap_contas: 20, ordem: 15 },
  { nome: "Felipe Almeida",  match_responsavel: "Felipe Almeida",  categoria: "vendedor", cap_recorrente: null, cap_mrr: 65812.50,  cap_pontual: null, cap_contas: 20, ordem: 16 },
  { nome: "Richard Meira",   match_responsavel: "Richard Meira",   categoria: "vendedor", cap_recorrente: null, cap_mrr: 59980,     cap_pontual: null, cap_contas: 20, ordem: 17 },

  // ── Accounts ──
  { nome: "Moises",       match_responsavel: "Moises Silva Fernandes",   categoria: "account", cap_recorrente: null, cap_mrr: 76085.63, cap_pontual: null, cap_contas: 30, ordem: 18 },
  { nome: "Pedro",        match_responsavel: "Pedro Antonio",            categoria: "account", cap_recorrente: null, cap_mrr: 86685,    cap_pontual: null, cap_contas: 30, ordem: 19 },
  { nome: "Leonardo Acc", match_responsavel: "Leonardo Soares Ferreira", categoria: "account", cap_recorrente: null, cap_mrr: 104650,   cap_pontual: null, cap_contas: 25, ordem: 20 },
  { nome: "Breno Acc",    match_responsavel: "Breno Carmo",              categoria: "account", cap_recorrente: null, cap_mrr: 60376.56, cap_pontual: null, cap_contas: 25, ordem: 21 },

  // ── Gestores / Accounts Prime ──
  { nome: "Victor Arpini (Account Prime)", match_responsavel: "Victor Arpini",      categoria: "gestor", cap_recorrente: null, cap_mrr: 57411.76, cap_pontual: null, cap_contas: 10, ordem: 22 },
  { nome: "Jonatas (Account)",             match_responsavel: "Jônatas Cavalcante", categoria: "gestor", cap_recorrente: null, cap_mrr: 67396.88, cap_pontual: null, cap_contas: 25, ordem: 23 },
  { nome: "Renan (Account)",               match_responsavel: "Renan Fortunato",    categoria: "gestor", cap_recorrente: null, cap_mrr: 70126.04, cap_pontual: null, cap_contas: 25, ordem: 24 },
  { nome: "Thiago Andrey (Gestor Prime)",  match_responsavel: "Thiago Andrey",      categoria: "gestor", cap_recorrente: null, cap_mrr: 77085,    cap_pontual: null, cap_contas: 15, ordem: 25 },
  { nome: "Thiago Martins (Gestor Prime)", match_responsavel: "Thiago Martins",     categoria: "gestor", cap_recorrente: null, cap_mrr: 81794.06, cap_pontual: null, cap_contas: 15, ordem: 26 },
  { nome: "Allan (Gestor)",                match_responsavel: "Allan Gestor",       categoria: "gestor", cap_recorrente: null, cap_mrr: 84151.25, cap_pontual: null, cap_contas: 30, ordem: 27 },
  { nome: "Victor Matsushita (Gestor)",    match_responsavel: "Victor Matsushita",  categoria: "gestor", cap_recorrente: null, cap_mrr: 81652.11, cap_pontual: null, cap_contas: 30, ordem: 28 },
];
