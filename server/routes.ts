  ...
  try {
    ...
    if (coursesCount === 0) {
      ...
      const coursesData = [
        ...
        {id: "41700a33-7ddf-41fc-be6b-de4d7ca8e47c", nome: "Data Studio 2", status: "ativo", tema_principal: "Capacitação Pessoal", plataforma: "Nutror", url: "https://cursos.nutror.com/982948f35f6589d421ad6a4eb2fe3249825c2141?accounts_first_access_token=***REMOVED***", login: "rodrigo@nave.ac", senha: null, created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
