  ...
  app.get("/debug-cliente-faturas/:cnpj", async (req, res) => {
    try {
      ...
      const clienteResult = await db.execute(sql`
        SELECT id, nome, cnpj, ids FROM "Conta Azul".caz_clientes 
      ...
      const parcelasResult = await db.execute(sql`
        SELECT * FROM "Conta Azul".caz_parcelas 
      ...
      const receberResult = await db.execute(sql`
        SELECT * FROM "Conta Azul".caz_receber 
  ...
  app.get("/debug-patrimonio-mapping", async (req, res) => {
    try {
      const result = await db.execute(sql`
        ...
        LEFT JOIN "Inhire".rh_pessoal c ON TRIM(c.nome) = TRIM(p.responsavel_atual)
    ...
    try {
      ...
      for (const p of patrimonios) {
        ...
        if (melhorMatch && melhorScore >= 2) {
          await db.execute(sql`
            UPDATE "Inhire".rh_patrimonio SET responsavel_id = ${melhorMatch.id} WHERE id = ${p.id}
          `);
          updates.push({
            patrimonioId: p.id,
  ...
  try {
    ...
    if (coursesCount === 0) {
      ...
      const coursesData = [
        ...
        {id: "02e67491-84c9-4b3e-948b-104f3268f93b", nome: "Hunter Start", status: "ativo", tema_principal: "Comunicação", plataforma: "Própria", url: "https://membros.marcostrider.com.br/users/sign_in", login: "pedroferreira0309@hotmail.com", senha: "5G7mz9JQ", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "04b836b0-1a3f-437b-98f6-814f80945712", nome: "Guerrilha Way", status: "cancelado", tema_principal: "Desenvolvimento Pessoal", plataforma: "Própria", url: "https://app.guerrilhaway.com.br/login", login: "pedroferreira0309@hotmail.com", senha: "ts9ekj", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        ...
        {id: "09499419-78b1-44ee-a42d-1d95a92be8e0", nome: "Criadores 21", status: "ativo", tema_principal: "Marketing Digital/ Social Midia", plataforma: "Hotmart", url: "https://criadores21black.club.hotmart.com/", login: "raphael@vinteo.com.br", senha: "C21Vinteo!@#", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "0989d3f3-59c6-48e5-89ac-17f913d0a664", nome: "Curso de FIGMA", status: "vitalicio", tema_principal: "UI/UX Designer", plataforma: "Hotmart", url: "https://hotmart.com/en/club/cursodefigma/products/1890184/content/EOgQGr6Ge6", login: "partnersturbo@gmail.com", senha: "Turbo100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "11af770a-08a2-4223-8d05-06da072bf448", nome: "Contigenciamento de BM  Pai do Trafego", status: "ativo", tema_principal: "Contigenciamento de BM  Pai do Trafego", plataforma: "Não informada", url: "https://conteudofechado.astronmembers.com/entrar&logout", login: "gustavo.dias30@gmail.com", senha: "px2@PkK8pDDzjkW", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "126cea43-28c7-415a-b94a-b3c319654e98", nome: "Photoshop Descomplicado", status: "ativo", tema_principal: "Arte Visual", plataforma: "Hotmart", url: "https://photoshopdescomplicado.club.hotmart.com", login: "breno_@live.com", senha: "Turbo100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "145d2e96-3580-4afe-b050-b060c2e4f57f", nome: "Comunidade Sobral", status: "ativo", tema_principal: "Marketing / tráfego", plataforma: "Própria", url: "https://www.subido.com.br/login", login: "rodrigo.queiroz@turbopartners.com.br", senha: "Acelera100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "165b7652-4b5f-4ae0-af68-65dcc5c671d0", nome: "FigmaisPRO", status: "cancelado", tema_principal: "Webdesigner", plataforma: "Cademi", url: "https://figmaisacademy.cademi.com.br", login: "partnersturbo@gmail.com", senha: "58u7u1", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        ...
        {id: "1ba8670d-e61a-406a-a0c3-52cb855a762c", nome: "Profissão Tráfego", status: "ativo", tema_principal: "Marketing / Afiliado", plataforma: "Própria", url: "Própria", login: "gabriiel0@hotmail.com", senha: "7617674786", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "1bc8b61a-bc0f-4e6d-94e1-8be067afd64e", nome: "NestJS - Modern TypeScript Back-end Development", status: "ativo", tema_principal: "Programação backend", plataforma: "Udemy", url: "https://udemy.com/course/nestjs-zero-to-hero/learn", login: "thephfernandes@gmail.com", senha: "turbolearn", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        ...
        {id: "20aa9df4-e78d-4c28-9dd9-5f6c485c49c8", nome: "TURBO CLASS", status: "ativo", tema_principal: "Diversos", plataforma: "Kiwify", url: "Kiwify", login: "roberto.fachetti@turbopartners.com.br", senha: "Turbo1000*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        ...
        {id: "22825d46-9cc1-41f2-b576-1e8e870161c4", nome: "Pior Ano da sua Vida", status: "ativo", tema_principal: "Desenvolvimento Pessoal", plataforma: "Própria", url: "http://app.startgamification.com.br", login: "pav@pedro607", senha: "pedromattos", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "2523ab0c-73fb-4861-bc3a-5baa2bef237f", nome: "Henrique Marinho High Ticket", status: "cancelado", tema_principal: "Marketing Digital", plataforma: "Não informada", url: "https://henriquemarinho.curseduca.pro/", login: "raphaelmg.contato@gmail.com", senha: "002006Henrique", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "29b7cb60-958e-4944-86af-fba84c356d97", nome: "G4 AI", status: "ativo", tema_principal: "AI", plataforma: "Propria", url: "https://ai.g4educacao.com/", login: "rodrigo.queiroz@turbopartners.com.br", senha: "Turbo100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "2c229ae3-2e44-4f31-8fa8-631cae58f8e5", nome: "Criando clientes vendedores - Indicação", status: "ativo", tema_principal: "Marketing Digital", plataforma: "Hotmart", url: "https://criandoclientesvendedores20.club.hotmart.com/index", login: "romulo.felippe@hotmail.com", senha: "1ndik@321", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        ...
        {id: "2e2db7af-84bb-4249-8670-ec97c7d4d0a4", nome: "Comunidade Lendária", status: "cancelado", tema_principal: "Inteligência Artificial", plataforma: "Hotmart", url: "https://comunidade.vidalendaria.com.br/", login: "pedro.lorenzoni@turbopartners.com.br", senha: "Pedro2003!", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "2fb3d9ca-faca-4299-a0f4-d7157605c2b0", nome: "Blank School", status: "ativo", tema_principal: "Criação de conteúdo", plataforma: "Própria", url: "https://login.blankschool.com.br/", login: "contato@turbopartners.com.br", senha: "Turbo100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "3020266f-d59f-4fb4-8d9e-c351918fb39d", nome: "Portfólio Lucrativo", status: "ativo", tema_principal: "Arte Visual", plataforma: "Hotmart", url: "https://portfoliolucrativo.club.hotmart.com", login: "breno_@live.com", senha: "Turbo100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "3328465d-12f2-4509-afe5-cae67a6c5c78", nome: "Figcria - Rodrigo Bispo", status: "ativo", tema_principal: "Figma", plataforma: "Cakto", url: "https://app.rodrigobispo.com.br/campus/", login: "partnersturbo@gmail.com", senha: "4mpRgrYNM8", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "39783815-88e8-4b79-8fb1-5c388a5cd7e9", nome: "Formação Storytelling", status: "cancelado", tema_principal: "Marketing Digital", plataforma: "Própria", url: "https://escola.estadodaarte.com.br/", login: "otaviohenriquemkt@gmail.com", senha: "otavio123", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "3f13460e-bafa-474b-be99-a2bc5ce8c7a7", nome: "NEOART Academy", status: "sem_status", tema_principal: "Inteligencia Artificial para criar imagens e ativos", plataforma: "Kiwify", url: "https://dashboard.kiwify.com.br/", login: "partnersturbo@gmail.com", senha: "Turbo101*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "40d63788-d2a7-4089-9773-649f79317345", nome: "Desenvolver Temas Shopify", status: "ativo", tema_principal: "Programação", plataforma: "Udemy", url: "udemy.com.br", login: "breno_@live.com", senha: "brs112554", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "41700a33-7ddf-41fc-be6b-de4d7ca8e47c", nome: "Data Studio 2", status: "ativo", tema_principal: "Capacitação Pessoal", plataforma: "Nutror", url: "https://cursos.nutror.com/982948f35f6589d421ad6a4eb2fe3249825c2141?accounts_first_access_token=0d96dd5c-33cd-4903-bf64-79689ffa3258", login: "rodrigo@nave.ac", senha: "Nave100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        ...
        {id: "4a3b68f2-0b79-411f-a9bb-7f28aabd9e57", nome: "O Unico Plano - V4 Company", status: "ativo", tema_principal: "Marketing Digital", plataforma: "Cademi", url: "https://conteudo.v4company.com/area/vitrine", login: "rodrigo.queiroz@turbopartners.com.br", senha: "Turbo100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        ...
        {id: "4aaa869d-fc20-4242-99d4-32c60b793000", nome: "Swiper - EDITED", status: "vitalicio", tema_principal: "Copywriting", plataforma: "Própria", url: "https://swiper.com.br/", login: "peixotos.victor@gmail.com", senha: "Turbo100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "501e1885-321c-4b78-bf85-b063113c6b99", nome: "Negócio em um Fim de Semana", status: "ativo", tema_principal: "Marketing  Digital", plataforma: "Própria", url: "https://copyexperts.memberkit.com.br/", login: "pedroferreira0309@hotmail.com", senha: "281207analice", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "5295f0a4-a019-4058-b4ef-bb14656593d1", nome: "Stage", status: "cancelado", tema_principal: "Marketing Digital", plataforma: "Propria", url: "https://app.staage.com/", login: "victor.peixoto@turbopartners.com.br", senha: "7Ad%2Gu$5Vg", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "54ca276d-4e2d-4ec9-8c67-1cb8b84b5b3a", nome: "Alura", status: "ativo", tema_principal: "Produtividade / Programação", plataforma: "Udemy", url: "https://udemy.com/course/automate/learn/", login: "thephfernandes@gmail.com", senha: "turbolearn", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "55fd8b6e-596c-4701-8c2c-3c4adfdae313", nome: "Mentoria Naguel", status: "cancelado", tema_principal: "Marketing Digital Gestão", plataforma: "Hotmart", url: "https://mentoriaguilhermenagel.club.hotmart.com/", login: "joao.guarconi@turbopartners.com.br", senha: "Turbo100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "5cb49990-86d1-47cc-b5de-23780bb4d354", nome: "ManyChat", status: "ativo", tema_principal: "Automação - Whatsapp- Instagram e etc", plataforma: "Não informada", url: "https://membros.gestorautomator.com.br/", login: "gustavo.dias30@gmail.com", senha: "Turbo100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "5d372af7-7ea3-470f-92bb-eb364f424dfe", nome: "Agência de Sucesso", status: "ativo", tema_principal: "Marketing Digital", plataforma: "Hotmart", url: "https://planove20.club.hotmart.com/t", login: "arthurmach98@gmail.com", senha: "Ruthra123!", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "61266f87-0027-41d0-9224-441aa69a45de", nome: "Formação Gestor Digital", status: "cancelado", tema_principal: "Marketing Digital Gestão", plataforma: "Blue Rock", url: "https://bluerock.cademi.com.br/auth/login", login: "rodrigoqs9@gmail.com", senha: "acessobluerock", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "65ffdad3-e0b4-48af-a6a8-2e25e2402469", nome: "G4 Skills", status: "ativo", tema_principal: "Hards and soft skills", plataforma: "Própria", url: "Plataforma G4 Educação", login: "ferramentas@turbopartners.com.br", senha: "Turbo100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "67ccfe3c-9224-4f17-94d4-f11aa0ed5fdf", nome: "Metodologia HeyCommerce", status: "vitalicio", tema_principal: "Marketing Digital", plataforma: "Hotmart", url: "https://metodologiaheycommerce.club.hotmart.com/lesson/0OvwgQxW4j/", login: "robertofachetti3@gmail.com", senha: "Turbo100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "737104ee-fd32-4409-814f-6f3c86e3786d", nome: "Comunidade Mamba", status: "ativo", tema_principal: "Marketing Digital", plataforma: "Própria", url: "https://comunidade.mambaculture.com/", login: "pedroferreira0309@hotmail.com", senha: "281207Analice*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "73e4f1c4-6cd2-432a-86f5-b5764dfb4ce9", nome: "FL Insider", status: "ativo", tema_principal: "Marketing / tráfego", plataforma: "Própria", url: "https://flinsider.klickmembers.com.br", login: "pedroferreira0309@hotmail.com", senha: "e8Zoufyh", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "7bcfdc70-b5fa-4085-abe3-563282c75012", nome: "Edição de Alto Impacto", status: "ativo", tema_principal: "Edição de video", plataforma: "Hotmart", url: "https://hotmart.com/pt-BR/club/video-de-alto-impacto/products/3590732", login: "mateusm.souzaph@gmail.com", senha: "Turbo100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "806218da-e5cf-4ea8-9271-885bbba2bc67", nome: "Programa Liberdade Digital", status: "ativo", tema_principal: "Marketing Digital", plataforma: "Própria", url: "https://pld.xgrow.com/", login: "pedroferreira0309@hotmail.com", senha: "2O8TKy6h4Djv", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "8622536d-5924-4961-9cef-72bc9f9e4dbe", nome: "Pré-vestibular da Bola", status: "ativo", tema_principal: "Linguagem de Futebol", plataforma: "Hotmart", url: "https://futurocraqueacademyseucursopre.club.hotmart.com/lesson/kOXlEZDdOW/1-boas-vindas-e-historia", login: "arthurzon08@outlook.com.br", senha: "TurboZon18", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "8da717ec-4354-4517-9db7-b4d972f1f216", nome: "Vídeos de Colam - Hannah Franklin", status: "ativo", tema_principal: "Criação de conteúdo", plataforma: "Hotmart", url: "https://co.videosquecolam.co/pt-br/club/videosquecolam/products/4755870", login: "partnersturbo@gmail.com", senha: "Turbo100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "92289b54-2e82-4c59-9325-3ba38b75b7be", nome: "Métricas Boss", status: "ativo", tema_principal: "Performance Google Analytics GA4", plataforma: "Não informada", url: "https://prime.metricasboss.com.br/auth/login", login: "ferramentas@turbopartners.com.br", senha: "3au389", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "98347daf-e5ff-4ed8-90b9-8e03db1fc58e", nome: "Curso Cientista do Marketing Digital", status: "ativo", tema_principal: "Marketing Digital", plataforma: "Própria", url: "https://university.staage.com/s/login", login: "partnersturbo@gmail.com", senha: "Acelera100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "99e9954d-f055-4a2e-a813-e7dad068eb6b", nome: "Power BI - Xperiun", status: "ativo", tema_principal: "Curso de Power Bi rerefencia do mercado", plataforma: "Não informada", url: "https://xperiun.com/", login: "heitorg1701@gmail.com", senha: "Spike1020?", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "9d9b59ee-58f0-4955-a5a4-9f2589693287", nome: "Figmais pro", status: "cancelado", tema_principal: "Figma", plataforma: "Propria", url: "https://figmais.astronmembers.com/entrar", login: "partnersturbo@gmail.com", senha: "KrSm9OFpRZ", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "9de4cd85-b915-4084-9ea2-c8329445ac07", nome: "Design para Social Media", status: "ativo", tema_principal: "Arte Visual", plataforma: "Hotmart", url: "https://designparasocialmedia.club.hotmart.com", login: "breno_@live.com", senha: "Turbo100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "9fb0af7e-0440-47db-8435-b3e5cfb1b9cf", nome: "Curso Rocketseat", status: "ativo", tema_principal: "Programação", plataforma: "Própria", url: "https://app.rocketseat.com.br/home", login: "partnersturbo@gmail.com", senha: "Turbo1000*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "a0d445b0-8fc6-4a90-b7a9-abb89d8d62e9", nome: "Agência de Sucesso", status: "ativo", tema_principal: "Marketing Digital / Gestão", plataforma: "Hotmart", url: "https://planove20.club.hotmart.com/t", login: "arthurmach98@gmail.com", senha: "Ruthra123!", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "a45182f7-e794-47a1-be1e-c52da3c7d61e", nome: "6 em 30 - Micha Menezes", status: "cancelado", tema_principal: "Marketing  Digital", plataforma: "Hotmart", url: "https://aceleradordeanunciosoficial.club.hotmart.com/", login: "squadecriativo@gmail.com", senha: "squade112554", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "a7c7cb0b-b24f-43c0-8e64-a6c6025a69d6", nome: "Stories Animados", status: "ativo", tema_principal: "Arte Visual", plataforma: "Hotmart", url: "https://storiesanimados.club.hotmart.com", login: "breno_@live.com", senha: "Turbo100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "ab3b2d4b-ae27-4ec7-a6e6-4feae07c66f0", nome: "Copy Camp", status: "cancelado", tema_principal: "Copywriting", plataforma: "Própria", url: "https://www.empiricus.com.br/", login: "13705975765", senha: "Turbo1000*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "af0a407f-427b-4ba1-bdb5-3ce6084ea53a", nome: "Método Supernova", status: "ativo", tema_principal: "Crescimento do Instagram", plataforma: "Própria", url: "https://alunos.metodosupernova.com/area/vitrine", login: "inovevix.institucional@gmail.com", senha: "EspacoNave123!", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "b0c3f3b4-ba46-43f1-8ef3-a05bc91c3dec", nome: "Rede de Influencer - Agua Azul", status: "cancelado", tema_principal: "Mkt de Influencia", plataforma: "Propria", url: "https://ead.evermart.com.br/p/my-courses", login: "jsscaramussa@gmail.com", senha: "turbo100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "b6228c6f-1160-48f5-83d9-0210ca48d927", nome: "GTO: Comunidade Sobral ORGÂNICO", status: "ativo", tema_principal: "Marketing Digital", plataforma: "Própria", url: "https://gto.pedrosobral.com.br/", login: "rodrigo.queiroz@turbopartners.com.br", senha: "Acelera100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "bf6cac0f-d83d-4eb4-b50a-2597124ecc2c", nome: "Data Studio 1", status: "ativo", tema_principal: "Dados BI/Dashboard", plataforma: "Hotmart", url: "https://gestaodemetricastreinamentoava.club.hotmart.com/", login: "rodrigo@nave.ac", senha: "Nave100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "c556d17a-e1ad-439c-84a8-3e378f29d04a", nome: "A Caçada", status: "ativo", tema_principal: "Marketing /Lançamentos", plataforma: "Própria", url: "https://alunos.acacadadigital.com.br", login: "pedroferreira0309@hotmail.com", senha: "YJQadeeRjx", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        ...
        {id: "c9836105-097f-4036-a179-ccbfecb787f3", nome: "Close in Call", status: "ativo", tema_principal: "Vendas", plataforma: "Propria", url: "https://gravacao-intensivo.greenn.club/home", login: "victor.peixoto@turbopartners.com.br", senha: "Turbosenha*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "cfc4d562-8931-42b6-9eb1-a29b84309ba5", nome: "Os 4 Temperamentos Humanos", status: "ativo", tema_principal: "Desenvolvimento Pessoal", plataforma: "Própria", url: "https://app.reallifeapp.com.br/", login: "pedroferreira0309@hotmail.com", senha: "fafuan", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "d463b924-f52c-4722-b492-e734a517d25e", nome: "Nomade Milionário", status: "cancelado", tema_principal: "Marketing / PLR", plataforma: "Própria", url: "outliers.members.ticto.com.br", login: "hddigitalbusiness@gmail.com", senha: "heitordiego2019", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "d8cb2e6d-16a9-476d-b86c-01c481173e4c", nome: "Rocket Ship Comercial", status: "ativo", tema_principal: "Comercial", plataforma: "Própria", url: "http://url7150.cademi.com.br/ls/click", login: "contato@turbopartners.com.br", senha: "rocketship", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "ddb95d23-9134-42fd-8953-95dd0b7b3a78", nome: "Blueberry - Plataforma de cursos", status: "ativo", tema_principal: "Marketing Digital Gestão", plataforma: "Nutror", url: "https://blueberry.alpaclass.com/s/login", login: "joao.guarconi@turbopartners.com.br", senha: "Turbo100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "e0b7de27-0a38-4d17-a0d4-184ad724a864", nome: "Venda Todo Santo Dia", status: "vitalicio", tema_principal: "Marketing Digital/ Infoprodutos", plataforma: "Hotmart", url: "https://club.hotmart.com/oauth/login/?productId=1006882", login: "partnersturbo@gmail.com", senha: "Turbo100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "e21f5fbb-19d6-41ad-9bcd-a898a225c7fc", nome: "Visivius - Webflow", status: "sem_status", tema_principal: "Webdesigner", plataforma: "Própria", url: "https://aluno.vesuvius.com.br/users/sign_in", login: "breno.carmo@turbopartners.com.br", senha: "ApDXHXuL", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "e2a41264-d7bb-4f6a-99ee-f638432f36ce", nome: "Gestor de Performance", status: "ativo", tema_principal: "Marketing / tráfego", plataforma: "Hotmart", url: "https://gestordeperformance.club.hotmart.com/lesson/3eajWBKp7g/entre-no-grupo-de-whatsapp", login: "rodrigoqs9@gmail.com", senha: "Acelera100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "e521db93-2bb3-4194-af71-a36fab185426", nome: "Manipulação de Imagens", status: "ativo", tema_principal: "Arte Visual", plataforma: "Hotmart", url: "https://masterclassmanipulacaodeimagem.club.hotmart.com", login: "breno_@live.com", senha: "Turbo100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "ebe5c4b4-56af-4a76-88dd-bf1864814701", nome: "WebProcess", status: "vitalicio", tema_principal: "Webdesigner", plataforma: "Hotmart", url: "https://hotmart.com/en/club/webprocess/products/1850094/content/kOXXNdbNOW", login: "partnersturbo@gmail.com", senha: "Turbo100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "ed80a802-fa37-4f1f-89e0-48425c0c1125", nome: "Comunidade Zillo", status: "cancelado", tema_principal: "Marketing Digital / lançamento", plataforma: "Própria", url: "https://comunidade.priscilazillo.com.br/login", login: "pedroferreira0309@hotmail.com", senha: "69pw05", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        ...
        {id: "ee24b868-97d2-41fb-ab26-027b51cad228", nome: "Domestika - Cursos em Gerais", status: "vitalicio", tema_principal: "Designer", plataforma: "Domestika", url: "https://www.domestika.org/", login: "partnersturbo@gmail.com", senha: "Turbo100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        ...
        {id: "f276c104-13ae-4bb8-a5b2-1d5624accf58", nome: "No code Startup", status: "ativo", tema_principal: "Agentes e automações", plataforma: "Não informada", url: "https://flix.nocodestartup.io/login", login: "flavio.marquesjrp@gmail.com", senha: "Flavio159!", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "f32ffbf7-781a-4c77-b6a4-7b00fbb8a8cc", nome: "Fórmula de Lançamento", status: "cancelado", tema_principal: "Marketing / tráfego", plataforma: "Própria", url: "https://portal-fl.formuladelancamento.com.br", login: "pedroferreira0309@hotmail.com", senha: "mNitdRyK", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "f3bc8109-817a-4219-bfee-366696a76a1d", nome: "UX Design - AWARI", status: "ativo", tema_principal: "UX Design", plataforma: "Awari", url: "https://app.awari.com.br/", login: "gabriela.rsouza@outlook.com", senha: "Getsenha10*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "fbab9949-02c7-4a94-b7db-841e513ff23a", nome: "Proposta de Valor", status: "ativo", tema_principal: "Arte Visual", plataforma: "Hotmart", url: "https://treinamentopropostadevalor.club.hotmart.com", login: "breno_@live.com", senha: "Turbo100*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"},
        {id: "fe046ac1-7d6a-45ab-a7ad-7b50edd3de93", nome: "Cadu ADS", status: "ativo", tema_principal: "Marketing Digital", plataforma: "Própria", url: "https://membros2.escala3ps.com/", login: "peixotos.victor@gmail.com", senha: "Vanusa10*", created_by: "08874f6c-f5d9-4f6e-97e4-16358281930f"}
      ];
