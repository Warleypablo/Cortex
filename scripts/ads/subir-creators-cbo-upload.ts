/**
 * Passo 2/3 — Sobe pro Gerenciador os 6 vídeos do lote
 ...
 *
 *   npx tsx scripts/ads/subir-creators-cbo-upload.ts        # DRY (só mostra o plano)
 *   npx tsx scripts/ads/subir-creators-cbo-upload.ts --go   # baixa e sobe de verdade
 */
...
import { ALL_ITEMS, LOTE, metaTitle } from "./creators-cbo.data";
