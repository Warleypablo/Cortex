/**
 * Passo 1/3 — Cadastra na Biblioteca os 20 criativos do lote
 * "5 - Creators Summit - Camila/Jaque + Quebra de Objeções".
 * single-format: 1 linha/criativo, driveFileId = o único vídeo 9x16.
 * Ordem de cadastro (define os TP): Camila h1-4, Jaque h1-4, Objeções CTA01 c1-6, CTA02 c1-6.
 * IDEMPOTENTE: dedup por driveFileId.
 *
 *   npx tsx scripts/ads/subir-summit-cjo-planilha.ts        # DRY (mostra o plano, não grava)
 *   npx tsx scripts/ads/subir-summit-cjo-planilha.ts --go   # grava
 */
...
import { ALL_ITEMS, LOTE, PRODUTO, PLATAFORMA, TIPO_AD, driveLink } from "./summit-cjo.data";
