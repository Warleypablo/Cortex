/**
 * Sobe o lote CRM Recompra **b1c2** (h1–h9 = TP1639–TP1647) na camp CBO FLASH CRM,
 ...
 * e calcula o próximo NN a partir dos conjuntos da campanha. Idempotente + backoff de
 * rate-limit (quota dev-tier saturada).
 *
 *   npx tsx subir-crm-b1c2.ts        # DRY (descobre e mostra o plano; não escreve)
 *   npx tsx subir-crm-b1c2.ts --go   # cria
 */
