...
export type ProximoAniversarioEmpresa = {
  id: number;
  nome: string;
  admissao: Date;
...
export type TempoMedioPromocaoPorSquad = {
  squad: string;
  tempoMedioMeses: number;
  totalColaboradores: number;
};

export type GegOverview = {
  headcountAtual: number;
  turnoverPeriodo: number;
  admissoesPeriodo: number;
  demissoesPeriodo: number;
  tempoMedioAtivoMeses: number;
  headcountLiquidoPeriodo: number;
  taxaRetencao: number;
  aniversariantes: Aniversariante[];
  proximosAniversariosEmpresa: ProximoAniversarioEmpresa[];
};

export type GegHeadcountTrend = {
  mes: string;
  headcount: number;
  admissoes: number;
  demissoes: number;
...
export type GegDemissoesBreakdown = {
  motivo: string;
  quantidade: number;
  percentual: number;
};
