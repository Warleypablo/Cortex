...
export const PERMISSION_KEYS = {
  ...
  GROWTH: {
    ...
    CRIATIVOS_BIBLIOTECA: 'growth.criativos_biblioteca',
...
export const ROUTE_TO_PERMISSION: Record<string, string> = {
  ...
  '/growth/criativos/biblioteca': PERMISSION_KEYS.GROWTH.CRIATIVOS_BIBLIOTECA,
  '/growth/auto-report': PERMISSION_KEYS.REPORTS.AUTO_REPORT,
  '/growth/orcado-realizado': PERMISSION_KEYS.GROWTH.ORCADO_REALIZADO,
  '/growth/evolucao-temporal': PERMISSION_KEYS.GROWTH.EVOLUCAO_TEMPORAL,
  '/growth/orcamento-campanhas': PERMISSION_KEYS.GROWTH.ORCAMENTO_CAMPANHAS,
  '/growth/creator-summit': PERMISSION_KEYS.GROWTH.CREATOR_SUMMIT,
  ...
  '/growth/organico': PERMISSION_KEYS.GROWTH.ORGANICO,
  '/crm-instagram': PERMISSION_KEYS.GROWTH.CRM_INSTAGRAM,
  ...
  setores: [
    ...
    },
    {
      ...
      items: [
        ...
        { title: 'Creator Summit', url: '/growth/creator-summit', icon: 'PartyPopper', permissionKey: PERMISSION_KEYS.GROWTH.CREATOR_SUMMIT },
        ...
        { title: 'Orgânico', url: '/growth/organico', icon: 'Sprout', permissionKey: PERMISSION_KEYS.GROWTH.ORGANICO },
        { title: 'CRM Instagram', url: '/crm-instagram', icon: 'Users', permissionKey: PERMISSION_KEYS.GROWTH.CRM_INSTAGRAM },
...
export const PERMISSION_LABELS: Record<string, string> = {
  ...
  [PERMISSION_KEYS.FIN.REVENUE_GOALS]: 'Metas de Receita',
  ...
  [PERMISSION_KEYS.GROWTH.ORGANICO]: 'Orgânico',
  [PERMISSION_KEYS.GROWTH.CRIATIVOS]: 'Criativos',
  [PERMISSION_KEYS.GROWTH.CRIATIVOS_BIBLIOTECA]: 'Biblioteca de Criativos',
