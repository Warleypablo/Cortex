 ...
 *
 *   npx tsx pipeline-clickup-ads.ts                # dry-run: varre a lista, mostra o plano (não escreve nada)
 *   npx tsx pipeline-clickup-ads.ts --task 86xxxx  # dry-run de UMA task específica (qualquer status)
 *   npx tsx pipeline-clickup-ads.ts --live         # EXECUTA de verdade (cria conjuntos, manda WhatsApp, comenta)
 *   npx tsx pipeline-clickup-ads.ts --task 86xxxx --live
 *
